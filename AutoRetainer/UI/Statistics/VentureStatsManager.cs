...
public sealed class VentureStatsManager
{
    ...
    internal Dictionary<string, uint> RetTotal = new();
    internal Dictionary<(string Char, string Ret), HashSet<long>> VentureTimestamps = new();
    string Filter = "";
    ...
    int GetVentureCount(string character)
    {
        var ret = 0;
    ...
    int GetVentureCount(string character, string retainer)
    {
    ...
    void AddData(string character, string retainer, uint item, bool hq, uint amount, long timestamp)
    {
