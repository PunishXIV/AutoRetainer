...
public class MultiModeContingency : NeoUIEntry
{
		...
		public override NuiBuilder Builder { get; init; } = new NuiBuilder()
				...
				.EnumComboFullWidth(null, "Inventory at Capacity", () => ref C.FailureNoInventory, (x) => x != WorkshopFailAction.ExcludeVessel, null, "Applies selected fallback action in the case of the captain's inventory having insufficient space to receive voyage rewards.")
