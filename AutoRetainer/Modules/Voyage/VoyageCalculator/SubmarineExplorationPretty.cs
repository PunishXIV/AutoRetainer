...
public class SubmarineExplorationPretty : SubmarineExploration
{
    ...
    public string FancyDestination() => $"[{Svc.Data.GetExcelSheet<SubmarineExplorationPretty>(ClientLanguage.Japanese).GetRow(RowId).Location}] " + Utils.UpperCaseStr(Destination);
}
