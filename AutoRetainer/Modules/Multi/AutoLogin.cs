...
internal unsafe class AutoLogin
{
		...
		private void RecordLastData(string WorldName, string characterName, uint charaWorld, int serviceAccount)
		{
		...
		private bool OpenDataCenterMenu()
		{
		...
		private bool TitleScreenClickStart()
		{
		...
		private bool Delay5s()
		{
				Delay = 300;
				return true;
		}

		private bool Delay1s()
		{
				Delay = 60;
				return true;
		}
